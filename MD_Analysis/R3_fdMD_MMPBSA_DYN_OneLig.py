...
def main() :
  ...
  UTILS = '/home/jaime/guillemc/prog/utils'
  TLEAP = 'tleap20'
  ...
  if not info_from_top :
    res_prot     = 608 # 521 Residuos de la proteina

  info_from_nc   = True

  dir_param      = '/home/jaime/guillemc/mpro_fragments/MD_frags/mpro0005/leap'
  lig_parm       = 'mpro0005.parm'
  lig_prep       = 'mpro0005.prep'

  system_name    = 'mpro0005'
  ...
  AMBERHOME = '/programas/amber20/amber20'
  AMBER_ENV = '/programas/amber20/amber20/amber.sh'
